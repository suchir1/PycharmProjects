...
D_in, H_1, H_2, H_3, D_out = 88, 500, 250, 100, 2
...
model = torch.nn.Sequential(
    ...
    torch.nn.ReLU(), torch.nn.Linear(H_1, H_2), torch.nn.ReLU(), torch.nn.Linear(H_2, H_3), torch.nn.ReLU(), torch.nn.Linear(H_3, D_out),
     torch.nn.Softmax()
)
